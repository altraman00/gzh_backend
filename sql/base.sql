...
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`) VALUES ('6', NULL, '2020-03-12 09:09:52', NULL, '2020-03-18 10:06:29', '当被推荐者关注公众号后了，且推荐者的3人助力完成时', '0', '1', 'text', '【活动任务】\r\n恭喜，您的好友已经帮您完成了助力任务，点击领取秘籍吧！<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://gzh.supplus.cn&response_type=code&scope=snsapi_userinfo#wechat_redirect\">领取奖励</a>', NULL, '', '关注消息5——给推荐人推送任务已完成的消息', 'task_complete', NULL, NULL, NULL, NULL);
