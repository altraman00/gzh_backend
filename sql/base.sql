...
(100,0,'0','柠檬机构',0,'柠檬机构',null,null,'0','0','admin','2018-03-16 11:33:00',null,'2018-03-16 11:33:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=109 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='字典数据表';
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2030 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=155 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
...
CREATE TABLE `wx_user` (
  ...
  `mall_user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '商城用户ID',
  PRIMARY KEY (`id`)
...
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('1', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:29', '${上级好友微信昵称}——为分享者微信昵称； 此条信息发放给被推荐者', '0', '1', 'text', '【任务完成】\r\n\r\n您已帮好友${上级好友微信昵称}，助力成功。', NULL, '', '关注消息1——给关注者推送任务完成消息', 'help_success', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('2', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:35', '此条信息发放给被推荐者', '0', '1', 'text', '【任务未完成】 您已助力过，分享给其他好友帮忙助力吧。', NULL, '', '关注消息1——给关注者推送任务完成消息', 'has_help', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('3', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:37', '给被推荐者发送活动规则', '0', '1', 'text', 'Hi ${关注者微信昵称}, 你好!\n\n我是小M，这里有份MBA必备资料包！领取规则:\n1、只要三位好友助力，就能领取。\n2、将下面带有你头像的图片转发给好友或好友群。\n3、邀请好友关注公众号，即可助力成功。\n<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://act-fec.ministudy.com&response_type=code&scope=snsapi_userinfo#wechat_redirect\">点击查看活动详情</a>', NULL, '', '关注消息2——给关注人推送活动规则消息', 'activity_rule', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('4', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:38', '活动海报', '0', '1', 'poster', 'http://mmbiz.qpic.cn/mmbiz_png/TRQWU20qwKNjd3Uv3xD5SyUic83FFGwjxJj1l6MY1A2icdDoJGFdpia9GPDMxJzKpGibVUPxibcia6XbzWkLELeVrH2Q/0?wx_fmt=png', 'Q1ipCmTIBavTCEiOqjOaYGdQZJv_LMO4k8g0Qh0MYu4', '', '关注消息3——给关注人推送海报消息', 'activity_poster', '36,30', '530,986', 54, 160, NULL, NULL, NULL, 5);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('5', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:39', '当被推荐者关注公众号后了，且推荐者的3人助力未完成时 ${被推荐人昵称}为被分享者', '0', '1', 'text', '【活动任务】\r\n您的好友${被推荐人昵称}帮你助力了，还差${缺少个数}个助力，<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://act-fec.ministudy.com&response_type=code&scope=snsapi_userinfo#wechat_redirect\">查看任务详情</a>！', NULL, '', '关注消息4——给推荐人推送任务过程中的消息', 'be_helped', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`, `schedule_cron`, `schedule_class`, `schedule_method`, `sort_no`) VALUES ('6', NULL, '2020-03-12 09:09:52', NULL, '2020-03-24 10:46:46', '当被推荐者关注公众号后了，且推荐者的3人助力完成时', '0', '1', 'text', '【活动任务】\r\n恭喜，您的好友已经帮您完成了助力任务，点击领取资料包吧！<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://act-fec.ministudy.com&response_type=code&scope=snsapi_userinfo#wechat_redirect\">领取奖励</a>', NULL, '', '关注消息5——给推荐人推送任务已完成的消息', 'task_complete', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7);
...
INSERT INTO `wx_mp`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `app_id`, `app_name`, `app_identify`, `template_id`, `activity_enable`) VALUES ('1', NULL, '2020-03-11 16:00:23', NULL, '2020-03-12 13:31:21', NULL, '0', 'wx66fcb1f854cdab95', '柠檬在线学堂', 'online_study', NULL, NULL);
