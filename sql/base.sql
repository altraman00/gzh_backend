...
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`) VALUES ('3', NULL, '2020-03-12 09:09:52', NULL, '2020-03-18 15:09:15', '给被推荐者发送活动规则', '0', '1', 'text', 'Hi ${关注者微信昵称}！\r\n\r\n我是小M，这里有份MBA必备资料包！领取规则\r\n1、只要三位好友助力，就能领取。\r\n2、将下面带有你头像的图片转发给好友或好友群。\r\n3、邀请好友关注公众号，即可助力成功。', NULL, '', '关注消息2——给关注人推送活动规则消息', 'activity_rule', NULL, NULL, NULL, NULL);
...
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`) VALUES ('5', NULL, '2020-03-12 09:09:52', NULL, '2020-03-18 10:06:19', '当被推荐者关注公众号后了，且推荐者的3人助力未完成时 ${被推荐人昵称}为被分享者', '0', '1', 'text', '【活动任务】\r\n您的好友${被推荐人昵称}帮你助力了，还差${缺少个数}个助力，<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://gzh.supplus.cn&response_type=code&scope=snsapi_userinfo#wechat_redirect\">查看任务详情</a>！', NULL, '', '关注消息4——给推荐人推送任务过程中的消息', 'be_helped', NULL, NULL, NULL, NULL);
INSERT INTO `wx_activity_template_message`(`id`, `create_id`, `create_time`, `update_id`, `update_time`, `remark`, `del_flag`, `template_id`, `rep_type`, `rep_content`, `rep_media_id`, `rep_url`, `title`, `scene`, `avatar_coordinate`, `qrcode_coordinate`, `avatar_size`, `qrcode_size`) VALUES ('6', NULL, '2020-03-12 09:09:52', NULL, '2020-03-18 15:09:40', '当被推荐者关注公众号后了，且推荐者的3人助力完成时', '0', '1', 'text', '【活动任务】\r\n恭喜，您的好友已经帮您完成了助力任务，点击领取资料包吧！<a href = \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=&redirect_uri=http://gzh.supplus.cn&response_type=code&scope=snsapi_userinfo#wechat_redirect\">领取奖励</a>', NULL, '', '关注消息5——给推荐人推送任务已完成的消息', 'task_complete', NULL, NULL, NULL, NULL);
